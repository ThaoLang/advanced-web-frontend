...
export default function Classes({
    ...
    const fetchClassList = async () =>
    {
        const classes = [
            ...
            },
            {
                ...
                description: 'Administrative role overseeing and managing activities in English 301.',
            ...
            },
            {
                ...
                description: 'Administrative role handling tasks related to Geometry 401.',
            ...
            },
            {
                ...
                description: 'Administrative role overseeing and managing activities in Physics 501.',
            ...
            },
            {
                ...
                description: 'Experienced teacher guiding students through the intricacies of Chemistry 601.',
            ...
            },
            {
                ...
                description: 'Experienced teacher specializing in Advanced Web Programming 202.',
            ...
            },
            {
                ...
                description: 'Administrative role overseeing and managing activities in Internet of Things 901.',
    ...
    return (
        <div className="mx-auto max-w-screen-2xl h-screen p-4 md:p-6 2xl:p-10 bg-slate-100">
            <div className="text-xl breadcrumbs mx-auto max-w-screen-2xl mx-4 md:mx-6 2xl:mx-10 w-auto">
                <ul>
                    <li><Link href="/admin/">Home</Link></li>
                    <li><Link href="/admin/classes"><b>Classes</b></Link></li>
                </ul>
            </div>
            <div className="grid grid-cols-3 mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                ...
                <div className="col-start-0 col-span-3">
                    <Suspense key={query + currentPage}>
                        <ClassTable currentPage={currentPage}
