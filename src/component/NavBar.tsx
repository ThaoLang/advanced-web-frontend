        ...
        {user ? (
          <>
            ...
            <details className="dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="relative mt-3 z-[1] p-2 shadow menu dropdown-content bg-base-100 rounded-box h-auto w-80 space-y-10"
              >
                ...
                <li className="items-center">
                  <Link href="/profile">
                    <button className="btn btn-info border-1 border-black text-white font-">
                      Manage your account
                    </button>
                  </Link>
                  <Link
